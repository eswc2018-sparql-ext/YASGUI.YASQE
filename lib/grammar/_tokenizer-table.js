module.exports = {table:
{
  ...
  "*groupCondition" : {
     ...
     "UNNEST": ["groupCondition","*groupCondition"], 
  ...
  "*havingCondition" : {
     ...
     "UNNEST": ["havingCondition","*havingCondition"], 
  ...
  "*orderCondition" : {
     ...
     "(": ["orderCondition","*orderCondition"], 
     "UNNEST": ["orderCondition","*orderCondition"], 
     ...
     "TRUE": ["orderCondition","*orderCondition"], 
     "FALSE": ["orderCondition","*orderCondition"], 
     ...
     "AGGREGATE": ["orderCondition","*orderCondition"], 
     ...
     "STRING_LITERAL1": ["orderCondition","*orderCondition"], 
     "STRING_LITERAL2": ["orderCondition","*orderCondition"], 
     "STRING_LITERAL_LONG1": ["orderCondition","*orderCondition"], 
     "STRING_LITERAL_LONG2": ["orderCondition","*orderCondition"], 
     "INTEGER": ["orderCondition","*orderCondition"], 
     "DECIMAL": ["orderCondition","*orderCondition"], 
     "DOUBLE": ["orderCondition","*orderCondition"], 
     "INTEGER_POSITIVE": ["orderCondition","*orderCondition"], 
     "DECIMAL_POSITIVE": ["orderCondition","*orderCondition"], 
     "DOUBLE_POSITIVE": ["orderCondition","*orderCondition"], 
     "INTEGER_NEGATIVE": ["orderCondition","*orderCondition"], 
     "DECIMAL_NEGATIVE": ["orderCondition","*orderCondition"], 
     "DOUBLE_NEGATIVE": ["orderCondition","*orderCondition"], 
  ...
  "*tExpression" : {
     ...
     "UNNEST": ["tExpression","*tExpression"], 
     ...
     "AGGREGATE": ["tExpression","*tExpression"], 
  ...
  "additiveExpression" : {
     ...
     "(": ["multiplicativeExpression","*or([[+,multiplicativeExpression],[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),?or([[*,unaryExpression],[/,unaryExpression]])]])"], 
     "UNNEST": ["multiplicativeExpression","*or([[+,multiplicativeExpression],[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),?or([[*,unaryExpression],[/,unaryExpression]])]])"], 
     ...
     "AGGREGATE": ["multiplicativeExpression","*or([[+,multiplicativeExpression],[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),?or([[*,unaryExpression],[/,unaryExpression]])]])"], 
  ...
  "conditionalAndExpression" : {
     ...
     "(": ["valueLogical","*[&&,valueLogical]"], 
     "UNNEST": ["valueLogical","*[&&,valueLogical]"], 
     ...
     "AGGREGATE": ["valueLogical","*[&&,valueLogical]"], 
  ...
  "conditionalOrExpression" : {
     ...
     "(": ["conditionalAndExpression","*[||,conditionalAndExpression]"], 
     "UNNEST": ["conditionalAndExpression","*[||,conditionalAndExpression]"], 
     ...
     "AGGREGATE": ["conditionalAndExpression","*[||,conditionalAndExpression]"], 
  ...
  "expression" : {
     ...
     "(": ["conditionalOrExpression"], 
     "UNNEST": ["conditionalOrExpression"], 
     ...
     "AGGREGATE": ["conditionalOrExpression"], 
  ...
  "format" : {
     "FORMAT": ["FORMAT","{","primaryExpression","+tExpression","}"]}, 
  "functionCall" : {
  ...
  "multiplicativeExpression" : {
     ...
     "(": ["unaryExpression","*or([[*,unaryExpression],[/,unaryExpression]])"], 
     "UNNEST": ["unaryExpression","*or([[*,unaryExpression],[/,unaryExpression]])"], 
     ...
     "AGGREGATE": ["unaryExpression","*or([[*,unaryExpression],[/,unaryExpression]])"], 
  ...
  "relationalExpression" : {
     ...
     "(": ["numericExpression","?or([[=,numericExpression],[!=,numericExpression],[<,numericExpression],[>,numericExpression],[<=,numericExpression],[>=,numericExpression],[IN,expressionList],[NOT,IN,expressionList]])"], 
     "UNNEST": ["numericExpression","?or([[=,numericExpression],[!=,numericExpression],[<,numericExpression],[>,numericExpression],[<=,numericExpression],[>=,numericExpression],[IN,expressionList],[NOT,IN,expressionList]])"], 
     ...
     "AGGREGATE": ["numericExpression","?or([[=,numericExpression],[!=,numericExpression],[<,numericExpression],[>,numericExpression],[<=,numericExpression],[>=,numericExpression],[IN,expressionList],[NOT,IN,expressionList]])"], 
  ...
  "tExpression" : {
     "group": ["or([primaryExpression,box,format,group])"], 
     "VAR1": ["or([primaryExpression,box,format,group])"], 
     "VAR2": ["or([primaryExpression,box,format,group])"], 
     "BOX": ["or([primaryExpression,box,format,group])"], 
     "FORMAT": ["or([primaryExpression,box,format,group])"], 
     "(": ["or([primaryExpression,box,format,group])"], 
     "UNNEST": ["or([primaryExpression,box,format,group])"], 
     "STR": ["or([primaryExpression,box,format,group])"], 
     "LANG": ["or([primaryExpression,box,format,group])"], 
     "LANGMATCHES": ["or([primaryExpression,box,format,group])"], 
     "DATATYPE": ["or([primaryExpression,box,format,group])"], 
     "BOUND": ["or([primaryExpression,box,format,group])"], 
     "IRI": ["or([primaryExpression,box,format,group])"], 
     "URI": ["or([primaryExpression,box,format,group])"], 
     "BNODE": ["or([primaryExpression,box,format,group])"], 
     "RAND": ["or([primaryExpression,box,format,group])"], 
     "ABS": ["or([primaryExpression,box,format,group])"], 
     "CEIL": ["or([primaryExpression,box,format,group])"], 
     "FLOOR": ["or([primaryExpression,box,format,group])"], 
     "ROUND": ["or([primaryExpression,box,format,group])"], 
     "CONCAT": ["or([primaryExpression,box,format,group])"], 
     "STRLEN": ["or([primaryExpression,box,format,group])"], 
     "UCASE": ["or([primaryExpression,box,format,group])"], 
     "LCASE": ["or([primaryExpression,box,format,group])"], 
     "ENCODE_FOR_URI": ["or([primaryExpression,box,format,group])"], 
     "CONTAINS": ["or([primaryExpression,box,format,group])"], 
     "STRSTARTS": ["or([primaryExpression,box,format,group])"], 
     "STRENDS": ["or([primaryExpression,box,format,group])"], 
     "STRBEFORE": ["or([primaryExpression,box,format,group])"], 
     "STRAFTER": ["or([primaryExpression,box,format,group])"], 
     "YEAR": ["or([primaryExpression,box,format,group])"], 
     "MONTH": ["or([primaryExpression,box,format,group])"], 
     "DAY": ["or([primaryExpression,box,format,group])"], 
     "HOURS": ["or([primaryExpression,box,format,group])"], 
     "MINUTES": ["or([primaryExpression,box,format,group])"], 
     "SECONDS": ["or([primaryExpression,box,format,group])"], 
     "TIMEZONE": ["or([primaryExpression,box,format,group])"], 
     "TZ": ["or([primaryExpression,box,format,group])"], 
     "NOW": ["or([primaryExpression,box,format,group])"], 
     "UUID": ["or([primaryExpression,box,format,group])"], 
     "STRUUID": ["or([primaryExpression,box,format,group])"], 
     "MD5": ["or([primaryExpression,box,format,group])"], 
     "SHA1": ["or([primaryExpression,box,format,group])"], 
     "SHA256": ["or([primaryExpression,box,format,group])"], 
     "SHA384": ["or([primaryExpression,box,format,group])"], 
     "SHA512": ["or([primaryExpression,box,format,group])"], 
     "COALESCE": ["or([primaryExpression,box,format,group])"], 
     "IF": ["or([primaryExpression,box,format,group])"], 
     "STRLANG": ["or([primaryExpression,box,format,group])"], 
     "STRDT": ["or([primaryExpression,box,format,group])"], 
     "SAMETERM": ["or([primaryExpression,box,format,group])"], 
     "ISIRI": ["or([primaryExpression,box,format,group])"], 
     "ISURI": ["or([primaryExpression,box,format,group])"], 
     "ISBLANK": ["or([primaryExpression,box,format,group])"], 
     "ISLITERAL": ["or([primaryExpression,box,format,group])"], 
     "ISNUMERIC": ["or([primaryExpression,box,format,group])"], 
     "TRUE": ["or([primaryExpression,box,format,group])"], 
     "FALSE": ["or([primaryExpression,box,format,group])"], 
     "COUNT": ["or([primaryExpression,box,format,group])"], 
     "SUM": ["or([primaryExpression,box,format,group])"], 
     "MIN": ["or([primaryExpression,box,format,group])"], 
     "MAX": ["or([primaryExpression,box,format,group])"], 
     "AVG": ["or([primaryExpression,box,format,group])"], 
     "SAMPLE": ["or([primaryExpression,box,format,group])"], 
     "AGGREGATE": ["or([primaryExpression,box,format,group])"], 
     "GROUP_CONCAT": ["or([primaryExpression,box,format,group])"], 
     "SUBSTR": ["or([primaryExpression,box,format,group])"], 
     "REPLACE": ["or([primaryExpression,box,format,group])"], 
     "REGEX": ["or([primaryExpression,box,format,group])"], 
     "EXISTS": ["or([primaryExpression,box,format,group])"], 
     "NOT": ["or([primaryExpression,box,format,group])"], 
     "IRI_REF": ["or([primaryExpression,box,format,group])"], 
     "STRING_LITERAL1": ["or([primaryExpression,box,format,group])"], 
     "STRING_LITERAL2": ["or([primaryExpression,box,format,group])"], 
     "STRING_LITERAL_LONG1": ["or([primaryExpression,box,format,group])"], 
     "STRING_LITERAL_LONG2": ["or([primaryExpression,box,format,group])"], 
     "INTEGER": ["or([primaryExpression,box,format,group])"], 
     "DECIMAL": ["or([primaryExpression,box,format,group])"], 
     "DOUBLE": ["or([primaryExpression,box,format,group])"], 
     "INTEGER_POSITIVE": ["or([primaryExpression,box,format,group])"], 
     "DECIMAL_POSITIVE": ["or([primaryExpression,box,format,group])"], 
     "DOUBLE_POSITIVE": ["or([primaryExpression,box,format,group])"], 
     "INTEGER_NEGATIVE": ["or([primaryExpression,box,format,group])"], 
     "DECIMAL_NEGATIVE": ["or([primaryExpression,box,format,group])"], 
     "DOUBLE_NEGATIVE": ["or([primaryExpression,box,format,group])"], 
     "PNAME_LN": ["or([primaryExpression,box,format,group])"], 
     "PNAME_NS": ["or([primaryExpression,box,format,group])"]}, 
  "template" : {
     "TEMPLATE": ["prologue","templateClause","*datasetClause","whereClause","solutionModifier","valuesClause"], 
     "BASE": ["prologue","templateClause","*datasetClause","whereClause","solutionModifier","valuesClause"], 
     "PREFIX": ["prologue","templateClause","*datasetClause","whereClause","solutionModifier","valuesClause"]}, 
  "templateClause" : {
     "TEMPLATE": ["TEMPLATE","?nameArg","{","*tExpression","?[;,SEPARATOR,=,string]","}"]}, 
  "triplesBlock" : {
  ...
  "valueLogical" : {
     ...
     "AGGREGATE": ["relationalExpression"], 
